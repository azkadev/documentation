...
git init
git branch -M main
git remote add origin https://github.com/azkadev/documentation
git remote set-url --push origin https://azkadev:{main_github_token}@github.com/azkadev/documentation
